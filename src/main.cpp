...
int main(){
    ...
    TCODConsole::initRoot(42,24,"WOO!", true);
    ...
    Pokemon hero = Pokemon(10,10,64,TCODColor::white, TCODColor::black, false, false, "dick"); //figure out how to randomize position of hero
