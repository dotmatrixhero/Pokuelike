...
${OBJECTDIR}/TileInterpret.o: TileInterpret.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TileInterpret.o TileInterpret.cpp

${OBJECTDIR}/spritetest.o: spritetest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/spritetest.o spritetest.cpp
...
${OBJECTDIR}/Effects.o: Effects.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Effects.o Effects.cpp
