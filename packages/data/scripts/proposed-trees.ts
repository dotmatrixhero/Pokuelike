...
export const PROPOSED_TREES: Record<string, ProposedMove> = {
  harden: {
    ...
    tree: tree([
      ...
      { id: "slow_to_shift", name: "Slow to Shift", cost: 1, prerequisites: ["rooted_stance"], excludes: ["deep_reserve"], leaning: "boldness",
      ...
      { id: "deep_reserve", name: "Deep Reserve", cost: 1, prerequisites: ["rooted_stance"], excludes: ["slow_to_shift"], leaning: "boldness",
        delta: { maxPPBonus: 10 }, needsPrimitive: PPC,
        note: "FILLER FORK vs Slow to Shift — tempo or reserve. Only worth it if you took Chrysalis and Brittle Edge; on a shallow build it is a dead node, which is what makes it a real choice." },
      ...
      { id: "hold_position", name: "Hold Position", cost: 1, prerequisites: ["shared_stillness"], excludes: ["longer_stillness"], leaning: "sociability",
        delta: { allyEffectOnAttack: true } },
      { id: "longer_stillness", name: "Longer Stillness", cost: 1, prerequisites: ["shared_stillness"], excludes: ["hold_position"], leaning: "sociability",
        delta: { statChangeOnHit: { target: "self", stat: "defense", stage: 1, ticks: 140 } },
        note: "FILLER FORK vs Hold Position — share the guard, or hold your own for nearly three times as long." },
      ...
      { id: "grinding_plates", name: "Grinding Plates", cost: 1, prerequisites: ["splinter"], excludes: ["barbed_plates"], leaning: "aggression",
        delta: { cooldownTicks: -5 } },
      { id: "barbed_plates", name: "Barbed Plates", cost: 1, prerequisites: ["splinter"], excludes: ["grinding_plates"], leaning: "aggression",
        grantsPassive: { kind: "thorns", value: 0.1 }, delta: {},
        note: "FILLER FORK vs Grinding Plates — harden more often, or hurt more when bitten." },
  ...
  twineedle: {
    ...
    tree: tree([
      ...
      { id: "thin_point", name: "Thin Point", cost: 1, prerequisites: ["fourth_needle"], excludes: ["venom_sacs"], leaning: "aggression",
        delta: { defensePenetration: 0.15, forcedMovement: { mover: "attacker", direction: "closer", tiles: 2, timing: "beforeHit" } },
        note: "It closes the last two tiles itself, at speed, before the first needle lands — aggressive movement, the Aggression flavour this branch had none of." },
      { id: "venom_sacs", name: "Venom Sacs", cost: 1, prerequisites: ["fourth_needle"], excludes: ["thin_point"], leaning: "aggression",
        delta: { maxPPBonus: 8 }, needsPrimitive: PPC,
        note: "FILLER FORK vs Thin Point — the power-versus-PP split. On a 20 pool with Pincushion at 3/use, this is three more flurries; without Pincushion it is nothing." },
      { id: "needle_rhythm", name: "Needle Rhythm", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["thin_point"], ["venom_sacs"], ["blur_of_needles"], ["venom_mark"]], delta: { cooldownTicks: -1 } },
      { id: "pincushion", name: "Pincushion", cost: 2, prerequisites: ["needle_rhythm"], excludes: ["venom_lance"], leaning: "aggression",
        delta: { hits: { min: 4, max: 5 }, statusSeverity: 2, ppCost: 3 }, needsPrimitive: PPC,
        note: "FORK. 3 PP a use on a 20 pool — six flurries and the sacs are empty. Not more damage — worse venom. Every needle deepens what the last one left." },
      { id: "venom_lance", name: "Venom Lance", cost: 2, prerequisites: ["needle_rhythm"], excludes: ["pincushion"], leaning: "aggression",
        delta: { hits: { min: 2, max: 2 }, power: 20, defensePenetration: 0.25, lockTicks: 2 },
        note: "FORK. Two strikes that go all the way through, instead of five that skim — and it commits to them, which is the first thing in this tree that cannot be aborted." },
      ...
      { id: "wingbeat", name: "Wingbeat", cost: 1, prerequisites: ["never_landed"], excludes: ["wider_circuit"], leaning: "boldness", delta: { critRateStage: 1 } },
      { id: "wider_circuit", name: "Wider Circuit", cost: 1, prerequisites: ["never_landed"], excludes: ["wingbeat"], leaning: "boldness",
        delta: { range: { max: 3 } },
        note: "FILLER FORK vs Wingbeat — sharper passes, or a wider circle to make them from." },
      { id: "circling", name: "Circling", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["wingbeat"], ["wider_circuit"], ["blur_of_needles"], ["ambush_hive"]], delta: { accuracy: 10 } },
      ...
      { id: "no_stragglers", name: "No Stragglers", cost: 1, prerequisites: ["converge"], excludes: ["tending_drones"], leaning: "sociability", delta: { jamCooldownTicks: 8 } },
      { id: "tending_drones", name: "Tending Drones", cost: 1, prerequisites: ["converge"], excludes: ["no_stragglers"], leaning: "sociability",
        delta: { allyEffect: { healFraction: 0.12 } },
        note: "FILLER FORK vs No Stragglers — slow the target, or keep the swarm in the air." },
      { id: "hive_mind", name: "Hive Mind", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["no_stragglers"], ["tending_drones"], ["ambush_hive"], ["venom_mark"]], delta: { rallyCall: { ticks: 150 } } },
      ...
      { id: "nothing_forgets", name: "Nothing Forgets", cost: 2, prerequisites: ["one_mind"], leaning: "sociability",
        delta: { ppCost: 3, shape: { kind: "burst", radius: 1 }, needsPrimitive: PPC, hitsArea: true, statusSpreads: true, power: -8 },
  ...
  poison_sting: {
    ...
    tree: tree([
      ...
      { id: "no_appetite", name: "No Appetite", cost: 1, prerequisites: ["sickened"], excludes: ["quick_onset"], leaning: "boldness",
        delta: { statusNeedsInterference: { hunger: 0.25 } }, needsPrimitive: NEEDS },
      { id: "quick_onset", name: "Quick Onset", cost: 1, prerequisites: ["sickened"], excludes: ["no_appetite"], leaning: "boldness",
        delta: { statusSeverity: 1.8 },
        note: "FILLER FORK vs No Appetite — starve it slowly, or hurt it now." },
      ...
      { id: "finisher", name: "Finisher", cost: 1, prerequisites: ["venom_glut"], excludes: ["glut_sacs"], leaning: "aggression",
        delta: { situationalBonus: { condition: "targetStatused", multiplier: 1.4 } } },
      { id: "glut_sacs", name: "Glut Sacs", cost: 1, prerequisites: ["venom_glut"], excludes: ["finisher"], leaning: "aggression",
        delta: { maxPPBonus: 12 }, needsPrimitive: PPC,
        note: "FILLER FORK vs Finisher — hit the poisoned harder, or simply carry more venom. Power versus PP." },
      ...
      { id: "long_patrol", name: "Long Patrol", cost: 1, prerequisites: ["the_nest_eats"], excludes: ["close_nest"], leaning: "sociability",
        grantsPassive: { kind: "regenFlat", value: 1.5 }, delta: { range: { max: 2 } },
        note: "A patrolling nest recovers as it walks its circuit." },
      { id: "close_nest", name: "Close Nest", cost: 1, prerequisites: ["the_nest_eats"], excludes: ["long_patrol"], leaning: "sociability",
        grantsPassive: { kind: "healAura", value: 0.01 }, delta: {},
        note: "FILLER FORK vs Long Patrol — range and recovery on the move, or a tighter nest that heals harder." },
  ...
  growth: {
    ...
    tree: tree([
      ...
      { id: "seedbed", name: "Seedbed", cost: 1, prerequisites: ["old_ground"], excludes: ["hardpan"], leaning: "boldness",
      ...
      { id: "hardpan", name: "Hardpan", cost: 1, prerequisites: ["old_ground"], excludes: ["seedbed"], leaning: "boldness",
        grantsPassive: { kind: "damageReduction", value: 0.08 }, delta: {},
        note: "FILLER FORK vs Seedbed — ground that grows faster, or ground packed hard enough to stand on." },
      ...
      { id: "choking_out", name: "Choking Out", cost: 1, prerequisites: ["thicket"], excludes: ["spore_reserve"], leaning: "aggression",
        delta: { floraCompetition: 0.3 }, needsPrimitive: "Flora yield weighted by the forager's type (flora.ts harvest path)" },
      { id: "spore_reserve", name: "Spore Reserve", cost: 1, prerequisites: ["thicket"], excludes: ["choking_out"], leaning: "aggression",
        delta: { maxPPBonus: 10 }, needsPrimitive: PPC,
        note: "FILLER FORK vs Choking Out — richer ground for your own kind, or the reserve to plant twice as much of it. On a 20 pool with It Takes at 4/use this is two more bushes in a lifetime." },
      ...
      { id: "settle_here", name: "Settle Here", cost: 1, prerequisites: ["the_patch"], excludes: ["open_field"], leaning: "sociability",
        delta: { herdMigrationResistance: 0.4 }, needsPrimitive: MIGRATE,
        note: "A herd with a real farm stops wanting to leave." },
      { id: "open_field", name: "Open Field", cost: 1, prerequisites: ["the_patch"], excludes: ["settle_here"], leaning: "sociability",
        delta: { fertilityBoost: { amount: 0.4, radius: 4 } },
        note: "FILLER FORK vs Settle Here — a herd that stops moving, or a patch wide enough that it never has to." },
  ...
  agility: {
    ...
    tree: tree([
      ...
      { id: "no_bad_ground", name: "No Bad Ground", cost: 1, prerequisites: ["overland"], excludes: ["long_wind"], leaning: "boldness",
      ...
      { id: "long_wind", name: "Long Wind", cost: 1, prerequisites: ["overland"], excludes: ["no_bad_ground"], leaning: "boldness",
        delta: { statChangeOnHit: { target: "self", stat: "speed", stage: 2, ticks: 160 } },
        note: "FILLER FORK vs No Bad Ground — ignore the terrain, or simply keep going far longer on the terrain you have." },
      ...
      { id: "no_wind_down", name: "No Wind-Down", cost: 1, prerequisites: ["blur"], excludes: ["second_wind_agility"], leaning: "aggression",
        delta: { statChangeOnHit: { target: "self", stat: "speed", stage: 4, ticks: 90 } } },
      { id: "second_wind_agility", name: "Second Wind", cost: 1, prerequisites: ["blur"], excludes: ["no_wind_down"], leaning: "aggression",
        delta: { maxPPBonus: 10 }, needsPrimitive: PPC,
        note: "FILLER FORK vs No Wind-Down — a longer burst, or the reserve to do it more times. Faster Than Thought costs 3 a use." },
      ...
      { id: "the_stragglers", name: "The Stragglers", cost: 1, prerequisites: ["moving_as_one"], excludes: ["close_ranks_agility"], leaning: "sociability",
        grantsPassive: { kind: "herdHaste", value: 0.15 }, delta: {}, needsPrimitive: HERD_HASTE },
      { id: "close_ranks_agility", name: "Close Ranks", cost: 1, prerequisites: ["moving_as_one"], excludes: ["the_stragglers"], leaning: "sociability",
        grantsPassive: { kind: "calmingPresence", value: 0.15 }, delta: {},
        note: "FILLER FORK vs The Stragglers — pull the slow ones along, or move tightly enough that nothing challenges the column." },
