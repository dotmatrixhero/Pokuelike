  ...
  harden: {
    ...
    tree: tree([
      ...
      { id: "hardening_habit", name: "Hardening Habit", cost: 1, prerequisites: ["quick_set"], leaning: "boldness",
        delta: { cooldownTicks: -8, maxPPBonus: 10 }, needsPrimitive: PPC },
      ...
      { id: "dead_leaf", name: "Dead Leaf", cost: 1, prerequisites: ["still_as_bark"], leaning: "sociability", delta: { cooldownTicks: -4 } },
      ...
      { id: "splinter", name: "Splinter", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["shell_grit"], ["spines_out"]],
      ...
      { id: "sharded_break", name: "Sharded Break", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["barbed_plates"], ["ambush_shell"]],
        grantsPassive: { kind: "thorns", value: 0.15 },
  ...
  poison_sting: {
    ...
    tree: tree([
      ...
      { id: "nothing_recovers", name: "Nothing Recovers", cost: 1, prerequisites: ["long_odds"], leaning: "boldness",
        delta: { statusSpreads: true, statusSeverity: 2.5, rallyCall: { ticks: 300 }, ppCost: 3 }, needsPrimitive: PPC,
      ...
      { id: "venom_glut", name: "Venom Glut", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["deep_stick"], ["thickened_blood"]],
      ...
      { id: "run_it_down", name: "Run It Down", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["hunters_patience"], ["everyone_bites"]],
        delta: { situationalBonus: { condition: "targetLowHp", multiplier: 1.6 }, defensePenetration: 0.3 },
      ...
      { id: "the_long_meal", name: "The Long Meal", cost: 1, prerequisites: ["second_stomach"], leaning: "aggression",
        delta: { lifestealFraction: 0.4, situationalBonus: { condition: "targetLowHp", multiplier: 2 }, ppCost: 3 }, needsPrimitive: PPC,
  ...
  growth: {
    ...
    tree: tree([
      ...
      { id: "terraced", name: "Terraced", cost: 1, prerequisites: ["hardpan"], leaning: "boldness",
        grantsPassive: { kind: "healAura", value: 0.01 }, delta: { cooldownTicks: -10 } },
      { id: "worked_ground", name: "Worked Ground", cost: 1, leaning: "boldness",
        ...
        delta: { statChangeOnHit: { target: "self", stat: "defense", stage: 1, ticks: 120 } },
      ...
      { id: "thicket", name: "Thicket", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["spreading"], ["black_earth"]],
      ...
      { id: "monoculture", name: "Monoculture", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["choking_out"], ["feast"]],
  ...
  agility: {
    ...
    tree: tree([
      ...
      { id: "nothing_stops_it", name: "Nothing Stops It", cost: 1, prerequisites: ["dead_reckoning_ag"], leaning: "boldness",
        ...
        delta: { forcedMovement: { mover: "attacker", direction: "closer", tiles: 4, timing: "beforeHit" }, ppCost: 3 },
      ...
      { id: "blur", name: "Blur", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["wound_up"], ["downhill_run"]],
      ...
      { id: "afterimage", name: "Afterimage", cost: 1, prerequisites: ["quickening"], leaning: "aggression",
        ...
        delta: { statChangeOnHit: { target: "self", stat: "speed", stage: 6, ticks: 60 } }, needsPrimitive: UNNOTICED },
      { id: "untouchable", name: "Untouchable", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["afterimage"], ["the_lead"]],
      ...
      { id: "faster_than_thought", name: "Faster Than Thought", cost: 1, prerequisites: ["wide_open"], leaning: "aggression",
        ...
        delta: { critCooldownReset: true, hits: { min: 2, max: 2 }, ppCost: 3 },
