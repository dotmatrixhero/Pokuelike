...
export const PROPOSED_TREES: Record<string, ProposedMove> = {
  ...
  twineedle: {
    ...
    tree: tree([
      ...
      { id: "empty_the_sacs", name: "Empty the Sacs", cost: 2, prerequisites: ["hollowed_shafts"], leaning: "aggression",
      ...
      { id: "never_landed", name: "Never Landed", cost: 2, leaning: "boldness",
      ...
      { id: "high_pass", name: "High Pass", cost: 2, leaning: "boldness",
      ...
      { id: "dead_reckoning", name: "Dead Reckoning", cost: 1, prerequisites: ["gone_before_it_turns"], leaning: "boldness",
        delta: { accuracy: 15 } },
      { id: "never_there", name: "Never There", cost: 2, prerequisites: ["dead_reckoning"], leaning: "boldness",
      ...
      { id: "converge", name: "Converge", cost: 2, leaning: "sociability",
      ...
      { id: "drone_relay", name: "Drone Relay", cost: 2, leaning: "sociability",
      ...
      { id: "the_swarm_decides", name: "The Swarm Decides", cost: 2, prerequisites: ["hive_memory"], leaning: "sociability",
