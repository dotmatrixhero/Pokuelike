  ...
  harden: {
    ...
    tree: tree([
      ...
      { id: "honed_carapace", name: "Honed Carapace", cost: 2, prerequisites: ["keen_edges"], excludes: ["sharded_break"], leaning: "aggression",
        grantsPassives: [{ kind: "thorns", value: 0.06 }, { kind: "defenseBoost", value: 1 }], delta: {},
        note: "FORK. A shell that holds AND cuts, rather than one that pays for the cut by breaking." },
  ...
  twineedle: {
    ...
    tree: tree([
      ...
      { id: "drone_relay", name: "Drone Relay", cost: 2, prerequisites: ["hive_mind"], excludes: ["the_hive_decides"], leaning: "sociability",
        delta: { rallyCall: { ticks: 90 }, targetsAlly: true, allyEffect: { healFraction: 0.1, buff: { stat: "attack", stage: 1, ticks: 40 } } },
        note: "FORK. Shorter marks, but every drone that answers one comes back stronger." },
      { id: "one_mind", name: "One Mind", cost: 2, leaning: "sociability",
        prerequisitesAnyOf: [["the_hive_decides"], ["drone_relay"]], delta: { allyEffectOnAttack: true, cooldownTicks: -1 } },
      { id: "nothing_forgets", name: "Nothing Forgets", cost: 2, prerequisites: ["one_mind"], leaning: "sociability",
        ...
        note: "KEYSTONE. The mark outlives the Beedrill that set it." },
  ...
  growth: {
    ...
    tree: tree([
      ...
      { id: "homestead", name: "Homestead", cost: 2, prerequisites: ["common_ground"], excludes: ["the_commons"], leaning: "sociability",
        delta: { herdForageBonus: 0.5, herdMigrationResistance: 0.6, fertilityCeilingBoost: 0.4 }, needsPrimitive: FORAGE,
      ...
      { id: "the_commons", name: "The Commons", cost: 2, prerequisites: ["common_ground"], excludes: ["homestead"], leaning: "sociability",
        delta: { herdForageBonus: 0.35, fertilityBoost: { amount: 0.4, radius: 3 } }, needsPrimitive: FORAGE,
        note: "FORK. Ground good enough that other herds settle beside yours instead of contesting it." },
      { id: "granary", name: "Granary", cost: 2, leaning: "sociability",
        prerequisitesAnyOf: [["homestead"], ["the_commons"]],
        grantsPassive: { kind: "healAura", value: 0.012 }, delta: { herdForageBonus: 0.2 }, needsPrimitive: FORAGE },
  ...
  agility: {
    ...
    tree: tree([
      ...
      { id: "the_long_walk", name: "The Long Walk", cost: 2, prerequisites: ["trailbreaker"], excludes: ["the_short_way"], leaning: "boldness",
        grantsPassives: [{ kind: "dispersalSpeed", value: 0.5 }, { kind: "terrainUnhindered", value: 0.5 }], delta: {}, needsPrimitive: DISPERSAL,
        note: "FORK. Terrain stops mattering. A herd that keeps showing up somewhere new." },
      ...
      { id: "untouchable", name: "Untouchable", cost: 2, prerequisites: ["quickening"], excludes: ["afterimage"], leaning: "aggression",
        grantsPassives: [{ kind: "cooldownHaste", value: 0.25 }, { kind: "immovable", value: 1 }], delta: {}, needsPrimitive: HASTE,
        note: "FORK. Fast enough that nothing gets to move it, and everything it knows fires more often." },
      ...
      { id: "momentum", name: "Momentum", cost: 2, leaning: "aggression",
        ...
        grantsPassive: { kind: "cooldownHaste", value: 0.15 }, delta: {}, needsPrimitive: HASTE },
      ...
      { id: "the_crossing", name: "The Crossing", cost: 2, prerequisites: ["drumbeat"], excludes: ["the_column"], leaning: "sociability",
        grantsPassives: [{ kind: "herdHaste", value: 0.2 }, { kind: "dispersalSpeed", value: 0.6 }], delta: {}, needsPrimitive: DISPERSAL,
      ...
      { id: "the_column", name: "The Column", cost: 2, prerequisites: ["drumbeat"], excludes: ["the_crossing"], leaning: "sociability",
        grantsPassives: [{ kind: "herdHaste", value: 0.35 }, { kind: "healAura", value: 0.01 }], delta: {}, needsPrimitive: HERD_HASTE,
        note: "FORK. Not about crossing at all — a herd that simply always moves fast together, wherever it is." },
      { id: "one_pace", name: "One Pace", cost: 2, leaning: "sociability",
        prerequisitesAnyOf: [["the_crossing"], ["the_column"]],
        grantsPassive: { kind: "herdHaste", value: 0.15 }, delta: { allyEffectOnAttack: true }, needsPrimitive: HERD_HASTE },
      { id: "the_migration", name: "The Migration", cost: 2, prerequisites: ["one_pace"], leaning: "sociability",
        grantsPassives: [{ kind: "herdHaste", value: 0.25 }, { kind: "dispersalSpeed", value: 0.8 }], delta: {}, needsPrimitive: DISPERSAL,
        note: "KEYSTONE. The herd that crosses the map. This is the tree answering the thing the sim actually has a problem with." },
