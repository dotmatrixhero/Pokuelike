...
export const PROPOSED_TREES: Record<string, ProposedMove> = {
  harden: {
    ...
    tree: tree([
      ...
      { id: "rooted_stance", name: "Rooted Stance", cost: 1, prerequisites: ["deadweight"], leaning: "boldness",
      ...
      { id: "deep_reserve", name: "Deep Reserve", cost: 1, prerequisites: ["rooted_stance"], leaning: "boldness",
        delta: { maxPPBonus: 10 }, needsPrimitive: PPC,
        note: "ROUTE. Parallel to Slow to Shift — tempo or reserve. Only worth it if you took Chrysalis and Brittle Edge; on a shallow build it is a dead node, which is what makes it a real choice." },
      { id: "set_bone", name: "Set Bone", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["slow_to_shift"], ["deep_reserve"], ["spines_out"], ["armored_indifference"]],
        grantsPassive: { kind: "bulk", value: 0.15 }, delta: {}, needsPrimitive: BULK },
      { id: "chrysalis", name: "Chrysalis", cost: 1, prerequisites: ["set_bone"], excludes: ["quick_set"], leaning: "boldness",
        grantsPassive: { kind: "damageReduction", value: 0.2 }, delta: { lockTicks: 6, ppCost: 4 }, needsPrimitive: PPC,
        note: "FORK. 4 PP a use against a 30 pool: seven full Chrysalises and the shell is done. Voluntary helplessness: enormous mitigation bought with a real action lock. The roster has no other move where being unable to act is the point — chargeAttack spends its lock buying an attack, not survival." },
      { id: "quick_set", name: "Quick Set", cost: 1, prerequisites: ["set_bone"], excludes: ["chrysalis"], leaning: "boldness",
      ...
      { id: "dense_core", name: "Dense Core", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["chrysalis"], ["quick_set"]],
        grantsPassive: { kind: "bulk", value: 0.25 }, delta: {}, needsPrimitive: BULK },
      { id: "unbudgeable", name: "Unbudgeable", cost: 1, prerequisites: ["dense_core"], leaning: "boldness",
      ...
      { id: "not_food", name: "Not Food", cost: 1, leaning: "sociability",
        ...
        grantsPassive: { kind: "unnoticed", value: 1 }, delta: {}, needsPrimitive: UNNOTICED },
      { id: "shared_stillness", name: "Shared Stillness", cost: 1, prerequisites: ["not_food"], leaning: "sociability",
      ...
      { id: "longer_stillness", name: "Longer Stillness", cost: 1, prerequisites: ["shared_stillness"], leaning: "sociability",
        delta: { statChangeOnHit: { target: "self", stat: "defense", stage: 1, ticks: 140 } },
        note: "ROUTE. Parallel to Hold Position — share the guard, or hold your own for nearly three times as long." },
      { id: "bark_still", name: "Bark-Still", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["hold_position"], ["longer_stillness"], ["armored_indifference"], ["ambush_shell"]],
        grantsPassive: { kind: "unnoticed", value: 1 }, delta: {}, needsPrimitive: UNNOTICED,
        note: "Several hardened herd-mates near each other read as scenery together." },
      { id: "scenery", name: "Scenery", cost: 1, prerequisites: ["bark_still"], excludes: ["driftwood"], leaning: "sociability",
      ...
      { id: "driftwood", name: "Driftwood", cost: 1, prerequisites: ["bark_still"], excludes: ["scenery"], leaning: "sociability",
      ...
      { id: "wrong_tree", name: "Wrong Tree", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["scenery"], ["driftwood"]],
        grantsPassive: { kind: "calmingPresence", value: 0.2 }, delta: {} },
      { id: "let_it_pass", name: "Let It Pass", cost: 1, prerequisites: ["wrong_tree"], leaning: "sociability",
        grantsPassive: { kind: "huntTargetSkip", value: 1 }, delta: { ppCost: 2}, needsPrimitive: SKIP,
      ...
      { id: "sharp_seams", name: "Sharp Seams", cost: 1, prerequisites: ["brittle_ridge"], leaning: "aggression",
        ...
        note: "Whatever bit down spends the next few ticks dealing with it. jamCooldownTicks is shipped with sixteen users and none of them are a status move." },
      ...
      { id: "splinter", name: "Splinter", cost: 1, prerequisites: ["shell_grit"], leaning: "aggression",
        grantsPassive: { kind: "thorns", value: 0.15 },
        delta: { statusChance: 0.15, statusSpreads: true },
        note: "NOTABLE. A third of the bite comes back, and the splinters left in the wound fester — Harden's first status of any kind." },
      { id: "grinding_plates", name: "Grinding Plates", cost: 1, prerequisites: ["splinter"], leaning: "aggression",
        delta: { cooldownTicks: -5 } },
      { id: "barbed_plates", name: "Barbed Plates", cost: 1, prerequisites: ["splinter"], leaning: "aggression",
        grantsPassive: { kind: "thorns", value: 0.1 }, delta: {},
        note: "ROUTE. Parallel to Grinding Plates — harden more often, or hurt more when bitten." },
      { id: "keen_edges", name: "Keen Edges", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["grinding_plates"], ["barbed_plates"], ["spines_out"], ["ambush_shell"]],
        grantsPassive: { kind: "thorns", value: 0.08 }, delta: {} },
      { id: "sharded_break", name: "Sharded Break", cost: 1, prerequisites: ["keen_edges"], excludes: ["honed_carapace"], leaning: "aggression",
        grantsPassive: { kind: "thorns", value: 0.15 },
        delta: { shape: { kind: "ring", radius: 1 }, hitsArea: true },
        note: "FORK. The casing shatters outward — everything adjacent takes the fragments, not just whatever bit." },
      { id: "honed_carapace", name: "Honed Carapace", cost: 1, prerequisites: ["keen_edges"], excludes: ["sharded_break"], leaning: "aggression",
      ...
      { id: "brittle_edge", name: "Brittle Edge", cost: 1, prerequisites: ["jagged_answer"], leaning: "aggression",
        grantsPassive: { kind: "thornsRubble", value: 0.18 }, delta: { ppCost: 3}, needsPrimitive: RUBBLE,
  ...
  twineedle: {
    ...
    tree: tree([
      ...
      { id: "hollow_points", name: "Hollow Points", cost: 1, leaning: "aggression",
        ...
        delta: { statusSpreads: true, hitsArea: true, shape: { kind: "cone", length: 2, width: 2 } },
        note: "DEEP NOTABLE. Both lanes end here. Enough venom in the air that it comes off on whatever is standing behind the target." },
      ...
      { id: "empty_the_sacs", name: "Empty the Sacs", cost: 1, prerequisites: ["hollowed_shafts"], leaning: "aggression",
        delta: { hits: { min: 5, max: 6 }, statusSeverity: 4, ppCost: 5 }, needsPrimitive: PPC,
      ...
      { id: "circling_high", name: "Circling High", cost: 1, prerequisites: ["hit_and_gone"], leaning: "boldness", delta: { range: { max: 3 } } },
      ...
      { id: "high_pass", name: "High Pass", cost: 1, leaning: "boldness",
        ...
        delta: { range: { max: 4 }, hits: { min: 3, max: 3 }, power: -6 },
        note: "LANE H NOTABLE. Three strafing passes from out of reach instead of one committed dive." },
      { id: "gliding", name: "Gliding", cost: 1, prerequisites: ["high_pass"], leaning: "boldness", delta: { accuracy: 10, cooldownTicks: -1 } },
      ...
      { id: "drone_relay", name: "Drone Relay", cost: 1, leaning: "sociability",
        ...
        delta: { targetsAlly: true, allyEffect: { healFraction: 0.18, buff: { stat: "attack", stage: 1, ticks: 40 } } },
  ...
  poison_sting: {
    ...
    tree: tree([
      ...
      { id: "sickened", name: "Sickened", cost: 1, prerequisites: ["creeping_dose"], leaning: "boldness",
      ...
      { id: "quick_onset", name: "Quick Onset", cost: 1, prerequisites: ["sickened"], leaning: "boldness",
        delta: { statusSeverity: 1.8 },
        note: "ROUTE. Parallel to No Appetite — starve it slowly, or hurt it now." },
      { id: "patient", name: "Patient", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["no_appetite"], ["quick_onset"], ["thickened_blood"], ["the_starving_one"]],
        delta: { forcedMovement: { mover: "attacker", direction: "away", tiles: 1, timing: "onHit" } } },
      { id: "let_it_work", name: "Let It Work", cost: 1, prerequisites: ["patient"], excludes: ["quick_wilt"], leaning: "boldness",
      ...
      { id: "quick_wilt", name: "Quick Wilt", cost: 1, prerequisites: ["patient"], excludes: ["let_it_work"], leaning: "boldness",
      ...
      { id: "wasting", name: "Wasting", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["let_it_work"], ["quick_wilt"]],
        delta: { situationalBonus: { condition: "targetStatused", multiplier: 1.4 } } },
      { id: "nothing_recovers", name: "Nothing Recovers", cost: 1, prerequisites: ["wasting"], leaning: "boldness",
        delta: { ppCost: 3, statusNeedsInterference: { hunger: 0.75, thirst: 0.75, regen: 1 }, statusSpreads: true }, needsPrimitive: NEEDS,
      ...
      { id: "venom_glut", name: "Venom Glut", cost: 1, prerequisites: ["deep_stick"], leaning: "aggression",
        delta: { statusChance: 0.25, selfCostPerUse: { need: "energy", amount: 0.02 }, ppCost: 2 }, needsPrimitive: PPC,
        note: "NOTABLE. The first node in the roster to cost BOTH a need and PP — venom is a consumable twice over. Near-guaranteed poison, and producing that much venom actually costs the user energy. Shipped primitive with exactly one node using it today." },
      { id: "finisher", name: "Finisher", cost: 1, prerequisites: ["venom_glut"], leaning: "aggression",
        delta: { situationalBonus: { condition: "targetStatused", multiplier: 1.4 } } },
      { id: "glut_sacs", name: "Glut Sacs", cost: 1, prerequisites: ["venom_glut"], leaning: "aggression",
        delta: { maxPPBonus: 12 }, needsPrimitive: PPC,
        note: "ROUTE. Parallel to Finisher — hit the poisoned harder, or simply carry more venom. Power versus PP." },
      { id: "hunters_patience", name: "Hunter's Patience", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["finisher"], ["glut_sacs"], ["thickened_blood"], ["everyone_bites"]], delta: { critRateStage: 1 } },
      { id: "run_it_down", name: "Run It Down", cost: 1, prerequisites: ["hunters_patience"], excludes: ["dry_bite"], leaning: "aggression",
      ...
      { id: "dry_bite", name: "Dry Bite", cost: 1, prerequisites: ["hunters_patience"], excludes: ["run_it_down"], leaning: "aggression",
      ...
      { id: "bled_out", name: "Bled Out", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["run_it_down"], ["dry_bite"]], delta: { critRateStage: 1, critCooldownReset: true } },
      { id: "nothing_walks_away", name: "Nothing Walks Away", cost: 1, prerequisites: ["bled_out"], leaning: "aggression",
      ...
      { id: "the_nest_eats", name: "The Nest Eats", cost: 1, prerequisites: ["it_spreads"], leaning: "sociability",
      ...
      { id: "long_patrol", name: "Long Patrol", cost: 1, prerequisites: ["the_nest_eats"], leaning: "sociability",
        grantsPassive: { kind: "regenFlat", value: 1.5 }, delta: { range: { max: 2 } },
        note: "A patrolling nest recovers as it walks its circuit." },
      { id: "close_nest", name: "Close Nest", cost: 1, prerequisites: ["the_nest_eats"], leaning: "sociability",
        ...
        note: "ROUTE. Parallel to Long Patrol — range and recovery on the move, or a tighter nest that heals harder." },
      { id: "circling_nest", name: "Circling Nest", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["long_patrol"], ["close_nest"], ["the_starving_one"], ["everyone_bites"]], delta: { rallyCall: { ticks: 120 } } },
      { id: "nothing_leaves", name: "Nothing Leaves", cost: 1, prerequisites: ["circling_nest"], excludes: ["the_relay"], leaning: "sociability",
        grantsPassive: { kind: "nonTerritorial", value: 1 },
        delta: { rallyCall: { ticks: 200 }, jamCooldownTicks: 10 },
        note: "FORK. Marked, slowed and surrounded — a territory nothing wounded walks out of. The nest itself picks no fights it did not start with venom, which is what makes the boundary legible." },
      { id: "the_relay", name: "The Relay", cost: 1, prerequisites: ["circling_nest"], excludes: ["nothing_leaves"], leaning: "sociability",
      ...
      { id: "shared_table", name: "Shared Table", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["nothing_leaves"], ["the_relay"]], delta: { allyEffect: { healFraction: 0.15 }, cooldownTicks: -1 } },
      { id: "the_nest_decides", name: "The Nest Decides", cost: 1, prerequisites: ["shared_table"], leaning: "sociability",
        delta: { ppCost: 2, rallyCall: { ticks: 300 }, needsPrimitive: PPC, statusSpreads: true },
        note: "KEYSTONE." },
  ...
  growth: {
    ...
    tree: tree([
      ...
      { id: "patient_soil", name: "Patient Soil", cost: 1, prerequisites: ["deep_roots"], leaning: "boldness",
        ...
        note: "Rooting into ground you are improving means nothing shifts you off it. Planted-duration, the flavour a farming Boldness branch should obviously have had." },
      ...
      { id: "old_ground", name: "Old Ground", cost: 1, prerequisites: ["humus"], leaning: "boldness",
      ...
      { id: "seedbed", name: "Seedbed", cost: 1, prerequisites: ["old_ground"], leaning: "boldness",
        delta: { floraRegrowthMultiplier: 1.4, statChangeOnHit: { target: "self", stat: "defense", stage: 1, ticks: 120 } },
        needsPrimitive: "Local flora regrowth-rate modifier (flora.ts)",
        note: "A very long, very small guard — duration as the payoff, not magnitude." },
      { id: "hardpan", name: "Hardpan", cost: 1, prerequisites: ["old_ground"], leaning: "boldness",
        grantsPassive: { kind: "damageReduction", value: 0.08 }, delta: {},
        note: "ROUTE. Parallel to Seedbed — ground that grows faster, or ground packed hard enough to stand on." },
      { id: "worked_ground", name: "Worked Ground", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["seedbed"], ["hardpan"], ["black_earth"], ["the_standing_crop"]], delta: { fertilityBoost: { amount: 0.7, radius: 0 } } },
      { id: "it_takes", name: "It Takes", cost: 1, prerequisites: ["worked_ground"], excludes: ["terraced"], leaning: "boldness",
        delta: { createsTerrain: { terrain: "bush", chance: 0.35, at: "self" }, ppCost: 4 }, needsPrimitive: TERRAIN_SELF + "; " + PPC,
        note: "FORK. 4 PP on a 20 pool — five bushes in a lifetime unless the tree buys headroom, which is exactly the weight planting a thing should carry. A bush where there was none. An Oddish gardens its zone into a food supply — visible on the map at a glance." },
      { id: "terraced", name: "Terraced", cost: 1, prerequisites: ["worked_ground"], excludes: ["it_takes"], leaning: "boldness",
        grantsPassive: { kind: "healAura", value: 0.01 },
        delta: { fertilityCeilingBoost: 0.5, cooldownTicks: -10 }, needsPrimitive: CEILING,
        note: "FORK. No new plants — just ground so good that whatever stands on it thrives, herd-mates included." },
      { id: "deep_loam", name: "Deep Loam", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["it_takes"], ["terraced"]],
        delta: { fertilityBoost: { amount: 0.5, radius: 1 } } },
      { id: "the_orchard", name: "The Orchard", cost: 1, prerequisites: ["deep_loam"], leaning: "boldness",
        grantsPassive: { kind: "regen", value: 0.02 },
        delta: { ppCost: 4, createsTerrain: { terrain: "tree", chance: 0.2, at: "self" }, lockTicks: 4 }, needsPrimitive: TERRAIN_SELF,
        note: "KEYSTONE. Trees, eventually — and growing one takes real, immobile commitment. The slowest payoff in the roster and the only one measured in centuries of sim-time." },
      ...
      { id: "quicker_season", name: "Quicker Season", cost: 1, prerequisites: ["creeping_edge"], leaning: "aggression",
        delta: { cooldownTicks: -8, gatherBurst: 2 },
        note: "The patch it just enriched can be stripped immediately. gatherBurst is shipped and had exactly four users in the whole roster." },
      ...
      { id: "thicket", name: "Thicket", cost: 1, prerequisites: ["spreading"], leaning: "aggression",
        delta: { fertilityBoost: { amount: 0.35, radius: 3 }, shape: { kind: "burst", radius: 3 }, hitsArea: true },
        note: "NOTABLE. A real patch, not a tile — and the growth itself is now an area event, which is where a shape change belongs (principle 14)." },
      ...
      { id: "spore_reserve", name: "Spore Reserve", cost: 1, prerequisites: ["thicket"], leaning: "aggression",
        delta: { maxPPBonus: 10 }, needsPrimitive: PPC,
        note: "ROUTE. Parallel to Choking Out — richer ground for your own kind, or the reserve to plant twice as much of it. On a 20 pool with It Takes at 4/use this is two more bushes in a lifetime." },
      { id: "root_war", name: "Root War", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["choking_out"], ["spore_reserve"], ["black_earth"], ["feast"]],
        delta: { forcedMovement: { mover: "defender", direction: "away", tiles: 1, timing: "onHit" } },
        note: "Ground going over to bramble physically shoves whatever was standing on it off. Repositioning, not enrichment — the branch's first non-soil lever." },
      { id: "overrun", name: "Overrun", cost: 1, prerequisites: ["root_war"], excludes: ["monoculture"], leaning: "aggression",
      ...
      { id: "monoculture", name: "Monoculture", cost: 1, prerequisites: ["root_war"], excludes: ["overrun"], leaning: "aggression",
      ...
      { id: "the_verge", name: "The Verge", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["overrun"], ["monoculture"]], delta: { fertilityBoost: { amount: 0.3, radius: 4 } } },
      { id: "it_was_all_grass", name: "It Was All Grass", cost: 1, prerequisites: ["the_verge"], leaning: "aggression",
      ...
      { id: "grazing_ground", name: "Grazing Ground", cost: 1, leaning: "sociability",
        ...
        grantsPassive: { kind: "healAura", value: 0.008 }, delta: {} },
      { id: "the_patch", name: "The Patch", cost: 1, prerequisites: ["grazing_ground"], leaning: "sociability",
      ...
      { id: "open_field", name: "Open Field", cost: 1, prerequisites: ["the_patch"], leaning: "sociability",
        delta: { fertilityBoost: { amount: 0.4, radius: 4 } },
        note: "ROUTE. Parallel to Settle Here — a herd that stops moving, or a patch wide enough that it never has to." },
      { id: "common_ground", name: "Common Ground", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["settle_here"], ["open_field"], ["the_standing_crop"], ["feast"]], delta: { herdForageBonus: 0.15 }, needsPrimitive: FORAGE },
      { id: "homestead", name: "Homestead", cost: 1, prerequisites: ["common_ground"], excludes: ["the_commons"], leaning: "sociability",
      ...
      { id: "the_commons", name: "The Commons", cost: 1, prerequisites: ["common_ground"], excludes: ["homestead"], leaning: "sociability",
      ...
      { id: "granary", name: "Granary", cost: 1, leaning: "sociability",
      ...
      { id: "nobody_leaves", name: "Nobody Leaves", cost: 1, prerequisites: ["granary"], leaning: "sociability",
  ...
  agility: {
    ...
    tree: tree([
      ...
      { id: "longer_stride", name: "Longer Stride", cost: 1, prerequisites: ["sure_footing"], leaning: "boldness",
        delta: { statChangeOnHit: { target: "self", stat: "speed", stage: 2, ticks: 70 }, range: { max: 2 } },
        note: "Reach as well as pace — `range` is shipped, cheap and almost unused at filler tier (template v3, rule 2)." },
      ...
      { id: "overland", name: "Overland", cost: 1, prerequisites: ["water_legs"], leaning: "boldness",
      ...
      { id: "no_bad_ground", name: "No Bad Ground", cost: 1, prerequisites: ["overland"], leaning: "boldness",
        ...
        note: "Something running for its life crosses ground it would never otherwise attempt. selfStateBonus is shipped with three users in the roster." },
      { id: "long_wind", name: "Long Wind", cost: 1, prerequisites: ["overland"], leaning: "boldness",
        delta: { statChangeOnHit: { target: "self", stat: "speed", stage: 2, ticks: 160 } },
        note: "ROUTE. Parallel to No Bad Ground — ignore the terrain, or simply keep going far longer on the terrain you have." },
      { id: "trailbreaker", name: "Trailbreaker", cost: 1, leaning: "boldness",
        prerequisitesAnyOf: [["no_bad_ground"], ["long_wind"], ["downhill_run"], ["the_pathfinders"]],
        grantsPassive: { kind: "terrainUnhindered", value: 0.2 }, delta: {}, needsPrimitive: UNHINDERED },
      { id: "the_long_walk", name: "The Long Walk", cost: 1, prerequisites: ["trailbreaker"], excludes: ["the_short_way"], leaning: "boldness",
      ...
      { id: "the_short_way", name: "The Short Way", cost: 1, prerequisites: ["trailbreaker"], excludes: ["the_long_walk"], leaning: "boldness",
        grantsPassive: { kind: "terrainUnhindered", value: 0.9 },
        delta: { cooldownTicks: -15, consumesOwnTerrain: { terrain: "mud", damageMultiplier: 1 } }, needsPrimitive: UNHINDERED,
        note: "FORK. Not faster between zones — able to go straight through the swamp instead of around it, and the swamp is a tile poorer for it." },
      ...
      { id: "nothing_stops_it", name: "Nothing Stops It", cost: 1, prerequisites: ["pathfinder"], leaning: "boldness",
        grantsPassives: [{ kind: "terrainUnhindered", value: 1 }, { kind: "dispersalSpeed", value: 0.5 }],
        delta: { ppCost: 2, forcedMovement: { mover: "attacker", direction: "closer", tiles: 4, timing: "beforeHit" } }, needsPrimitive: UNHINDERED,
        note: "KEYSTONE. Four tiles of ground closed before anything registers it moved. You read this one on the region map AND in a fight." },
      ...
      { id: "blur", name: "Blur", cost: 1, prerequisites: ["wound_up"], leaning: "aggression",
      ...
      { id: "second_wind_agility", name: "Second Wind", cost: 1, prerequisites: ["blur"], leaning: "aggression",
        delta: { maxPPBonus: 10 }, needsPrimitive: PPC,
        note: "ROUTE. Parallel to No Wind-Down — a longer burst, or the reserve to do it more times. Faster Than Thought costs 3 a use." },
      { id: "quickening", name: "Quickening", cost: 1, leaning: "aggression",
        prerequisitesAnyOf: [["no_wind_down"], ["second_wind_agility"], ["downhill_run"], ["the_lead"]],
        grantsPassive: { kind: "cooldownHaste", value: 0.1 }, delta: {}, needsPrimitive: HASTE },
      { id: "untouchable", name: "Untouchable", cost: 1, prerequisites: ["quickening"], excludes: ["afterimage"], leaning: "aggression",
      ...
      { id: "afterimage", name: "Afterimage", cost: 1, prerequisites: ["quickening"], excludes: ["untouchable"], leaning: "aggression",
      ...
      { id: "faster_than_thought", name: "Faster Than Thought", cost: 1, prerequisites: ["momentum"], leaning: "aggression",
        grantsPassive: { kind: "cooldownHaste", value: 0.3 },
        delta: { statChangeOnHit: { target: "self", stat: "speed", stage: 6, ticks: 120 }, ppCost: 3 },
        needsPrimitive: HASTE + "; " + PPC,
        note: "KEYSTONE." },
      ...
      { id: "no_one_behind", name: "No One Behind", cost: 1, leaning: "sociability",
        ...
        grantsPassive: { kind: "healAura", value: 0.006 }, delta: {} },
      { id: "moving_as_one", name: "Moving as One", cost: 1, prerequisites: ["no_one_behind"], leaning: "sociability",
      ...
      { id: "close_ranks_agility", name: "Close Ranks", cost: 1, prerequisites: ["moving_as_one"], leaning: "sociability",
        grantsPassive: { kind: "calmingPresence", value: 0.15 }, delta: {},
        note: "ROUTE. Parallel to The Stragglers — pull the slow ones along, or move tightly enough that nothing challenges the column." },
      { id: "drumbeat", name: "Drumbeat", cost: 1, leaning: "sociability",
        prerequisitesAnyOf: [["the_stragglers"], ["close_ranks_agility"], ["the_pathfinders"], ["the_lead"]],
        grantsPassive: { kind: "herdHaste", value: 0.1 }, delta: {}, needsPrimitive: HERD_HASTE },
      { id: "the_crossing", name: "The Crossing", cost: 1, prerequisites: ["drumbeat"], excludes: ["the_column"], leaning: "sociability",
      ...
      { id: "the_column", name: "The Column", cost: 1, prerequisites: ["drumbeat"], excludes: ["the_crossing"], leaning: "sociability",
      ...
      { id: "one_pace", name: "One Pace", cost: 1, leaning: "sociability",
      ...
      { id: "the_migration", name: "The Migration", cost: 1, prerequisites: ["one_pace"], leaning: "sociability",
        grantsPassives: [{ kind: "dispersalSpeed", value: 1 }, { kind: "healAura", value: 0.01 }], delta: { ppCost: 3}, needsPrimitive: DISPERSAL,
