...
${OBJECTDIR}/_ext/1445274692/TileInterpret.o: ../../src/TileInterpret.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/TileInterpret.o ../../src/TileInterpret.cpp

${OBJECTDIR}/_ext/1445274692/MapGenerator.o: ../../src/MapGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/MapGenerator.o ../../src/MapGenerator.cpp

${OBJECTDIR}/_ext/1445274692/Item.o: ../../src/Item.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/Item.o ../../src/Item.cpp
...
${OBJECTDIR}/_ext/1445274692/Gameplay.o: ../../src/Gameplay.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/Gameplay.o ../../src/Gameplay.cpp

${OBJECTDIR}/_ext/1445274692/Drawable.o: ../../src/Drawable.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/Drawable.o ../../src/Drawable.cpp
...
${OBJECTDIR}/_ext/1445274692/MapManager.o: ../../src/MapManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/MapManager.o ../../src/MapManager.cpp

${OBJECTDIR}/_ext/1445274692/Effect.o: ../../src/Effect.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/Effect.o ../../src/Effect.cpp

${OBJECTDIR}/_ext/1445274692/Terrain.o: ../../src/Terrain.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/Terrain.o ../../src/Terrain.cpp
